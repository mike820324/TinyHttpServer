...
void get_token(token *test, const char *buffer, const char *seper){
...
unsigned int get_token_num(const char *buffer, const char *seper){
	char *p;
	char *temp;
...
int tokencmp(token *input, const char *buffer){
	unsigned int i;
...
int tokencasecmp(token *input, const char *buffer){
	unsigned int i;
	for(i = 0 ; i < input->token_num ; i++){
